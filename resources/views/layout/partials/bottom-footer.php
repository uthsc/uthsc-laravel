    ...
    <div class="row collapse">
        <div class="columns text-center"><br>
            ...
            <div class="social-icon">
                <a href="https://facebook.com/uthsc"><i class="fa fa-facebook fa-2x fa-inverse"></i></a>
                <a href="https://twitter.com/uthsc"><i class="fa fa-twitter fa-2x fa-inverse"></i></a>
                <a href="https://instagram.com/uthsc"><i class="fa fa-instagram fa-2x fa-inverse"></i></a>
                <a href="https://linkedin.com/company/university-of-tennessee-health-science-center"><i class="fa fa-linkedin fa-2x fa-inverse"></i></a>
                <a href="https://youtube.com/user/uthsc"><i class="fa fa-youtube fa-2x fa-inverse"></i></a>
                <a href="https://pinterest.com/uthsc/"><i class="fa fa-pinterest fa-2x fa-inverse"></i></a>
            </div><br>
        </div>
    </div>
    <div class="row collapse">
